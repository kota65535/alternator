...
func init() {
	c := &cobra.Command{
		...
		Short: "Show the remote database schema changes required by the local schema file.",
		Long:  "Show the remote database schema changes required by the local schema file.",
